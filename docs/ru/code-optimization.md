...
Аудит репозитория от 2026-05-31 показал, что executable baseline соответствует
Stage 05. Основной drift был в development/local-environment документах,
которые всё ещё называли Stage 04 текущим baseline; эти документы обновлены
под Stage 05 repository manager APIs, migrations и worker behavior.
