...
проведи глубокий анализ кода и документации, оцени степень реализации stage-03-jobs-workers-status, дай рекомендации по оптимизации stage-03-jobs-workers-status, чтоб довести степень реализации до 100%

внеси соответствующие правки и повторяй цикл анализ/рекомендации/правки, пока реализация stage-03-jobs-workers-status не будет соответствовать 100%
